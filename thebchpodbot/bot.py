...
app.add_handler(CommandHandler('bot_help', bot_help))
...
app.add_handler(MessageHandler(TEXT, unknown))
app.add_handler(MessageHandler(COMMAND, unknown))  # Filters out unknown commands

# Filters out unknown messages.
app.add_handler(MessageHandler(TEXT, unknown_text))
